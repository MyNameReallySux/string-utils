...
describe('StringUtils', () => {
	describe('#contains', () => {
		...
		function testContains(string, phrase, expected = true){
		...
		function testContainsType(phrase, expected = undefined){
			// 'phrase is 'typeof phrase'
			it(`phrase is ${phrase}`, () => expect(StringUtils.contains(TEST.NORMAL, phrase)).equals(expected))
		}
		...
		describe('throws an error if', () => {
			it(`'string' is undefined or null`, () => {
				for(let element of THROWS){
					expect(() => StringUtils.capitalize(element)).throws()
				}
			})
		})
	})
	...
	describe('#capitalize', () => {
		...
		function testCapitalize(string, expected){
			// 'string'
	...
	describe('#toCamelCase', () => {
		...
		function testToCamelCase(string, expected, capitalize = false){
			// 'a string' to 'aString'
		...
		describe('throws an error if', () => {
			it(`'string' is not a string`, () => {
				for(let element of THROWS){
					expect(() => StringUtils.toCamelCase(element)).throws()
				}
			})
		})
	})
	...
	describe('#toKebabCase', () => {
		...
		function testToKebabCase(string, expected, capitalize = false){
		...
		describe('throws an error if', () => {
			it(`'string' is not a string`, () => {
				for(let element of THROWS){
					expect(() => StringUtils.toKebabCase(element)).throws()
				}
			})
		})
	})
	...
	describe('#toSnakeCase', () => {
		...
		function testToSnakeCase(string, expected, capitalize = false){
		...
		describe('throws an error if', () => {
			it(`'string' is not a string`, () => {
				for(let element of THROWS){
					expect(() => StringUtils.toSnakeCase(element)).throws()
				}
			})
		})
	})
	...
	describe('#toReadable', () => {
		...
		function testToReadable(string, expected, separator){
		...
		describe('throws an error if', () => {
			it(`'string' is not a string`, () => {
				for(let element of THROWS){
					expect(() => StringUtils.toReadable(element)).throws()
				}
			})
			
			it(`'separator' is not a string, (excluding undefined)`, () => {
				for(let element of THROWS){
					expect(() => StringUtils.toReadable(TEST.COMMA, element)).throws()
				}
			})
		})
	})
	...
	describe('#toWordArray', () => {
		...
		function testToWordArray(string, expected){
